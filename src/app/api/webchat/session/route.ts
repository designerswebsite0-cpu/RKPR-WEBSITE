...
export async function GET() {
  try {
    ...
    return logWebchatRouteError("session:GET", err);
  }
}
...
export async function POST() {
  try {
    ...
    return logWebchatRouteError("session:POST", err);
  }
}
...
export async function DELETE() {
  try {
    ...
    return logWebchatRouteError("session:DELETE", err);
  }
}
